...
list containing the level order traversal.
...
but instead of appending the last element of each level we will be appending the first element of
each level to the output array.
"""
